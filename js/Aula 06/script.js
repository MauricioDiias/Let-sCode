    ...
    switch(opcaoMenu) {
        ...
        case 1:
            ...
            arrayMaterial.push(Material);
                localStorage.setItem('Materiais',Material)
        break;

        case 2:
           
        const nomeMaterialRemover = prompt("Digite o nome do Material que deseja remover");
        localStorage.removeItem(Material.nome,nomeMaterialRemover)
        break;
